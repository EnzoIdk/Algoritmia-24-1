...
struct NodoArbol * crearNuevoNodoArbol(struct NodoArbol *, NodoLetra, 
                                                          struct NodoArbol *);
void plantarArbolBinario(struct ArbolBinario &, struct NodoArbol *, NodoLetra,
                                                       struct NodoArbol * );
void plantarArbolBinario(struct ArbolBinario &, struct ArbolBinario, NodoLetra,
                                                       struct ArbolBinario );
NodoLetra raiz(struct NodoArbol * nodo);
