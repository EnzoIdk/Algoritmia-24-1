...
struct NodoArbol * crearNuevoNodoArbol(struct NodoArbol *, Partido, 
                                                          struct NodoArbol *);
void plantarArbolBinario(struct ArbolBinario &, struct NodoArbol *, Partido,
                                                       struct NodoArbol * );
void plantarArbolBinario(struct ArbolBinario &, struct ArbolBinario, Partido,
                                                       struct ArbolBinario );
