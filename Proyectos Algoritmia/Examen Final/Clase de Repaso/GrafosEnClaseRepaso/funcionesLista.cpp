...
void insertarAlInicio(struct Lista & tad, struct Ciudad elemento) {
...
void insertarAlFinal(struct Lista & tad, struct Ciudad elemento) {
...
struct Nodo * crearNodo(struct Ciudad elemento, struct Nodo * siguiente) {
    struct Nodo * nuevoNodo = new struct Nodo;
    nuevoNodo->elemento = elemento;
...
void insertarEnOrden(struct Lista & tad, struct Ciudad elemento) {
...
struct Nodo * obtenerNodoAnterior(const struct Lista & tad, struct Ciudad elemento) {
...
struct Nodo * seEncuentra(const struct Lista & tad, struct Ciudad elemento) {
    struct Nodo * recorrido = tad.cabeza;
...
struct Ciudad retornaCabeza(struct Lista tad){
    return tad.cabeza->elemento;
}


void eliminaNodo(struct Lista & tad, struct Ciudad elemento) {
    struct Nodo * ultimo = nullptr;
    struct Nodo * recorrido = tad.cabeza;
