...
//            estaImprimiendoLaCabeza = 0;
            cout << recorrido->elemento/100000000<<setw(9)<<' '<<setfill('0')<<
                    setw(2)<<(recorrido->elemento%100000000)/1000000<<':'<<setw(2)
                    <<(recorrido->elemento%1000000)/10000<<setfill(' ')<<setw(14)<<
                    ' '<<setfill('0')<<setw(2)<<(recorrido->elemento%10000)/100<<
                    ':'<<setw(2)<<recorrido->elemento%100<<setfill(' ')<<endl;
            recorrido = recorrido->siguiente;
        }
    }
}