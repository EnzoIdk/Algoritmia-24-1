...
void plantarArbolBB(struct NodoArbol *& arbol, 
                    struct NodoArbol * arbolIzquierdo, NodoGen elemento, 
...
void insertarRecursivo(struct NodoArbol *& raiz, NodoGen elemento){
    if(esNodoVacio(raiz))
        ...
        if (raiz->elemento.fecha > elemento.fecha)
            ...
            if(raiz->elemento.fecha < elemento.fecha)
                ...
                cout<<endl<<"El elemento "<< elemento.fecha <<" ya se encuentra en el árbol"<< endl;
}
...
struct NodoArbol * eliminarNodoRecursivo(struct NodoArbol * nodo, NodoGen elemento){
    
    if(esNodoVacio(nodo))
        return nodo;
    //Buscamos el nodo a eliminar
    /*caso que el elemento a eliminar se encuentre a la izquierda*/
    if(nodo->elemento.fecha > elemento.fecha)
...
void  eliminarNodo(struct ArbolBinarioBusqueda & arbol, NodoGen dato){
