...
struct NodoArbol * crearNuevoNodoArbol(struct NodoArbol *, struct NodoGen, 
                                                          struct NodoArbol *);
void plantarArbolBinario(struct ArbolBinario &, struct NodoArbol *, struct NodoGen,
                                                       struct NodoArbol * );
void plantarArbolBinario(struct ArbolBinario &, struct ArbolBinario, struct NodoGen,
                                                       struct ArbolBinario );
