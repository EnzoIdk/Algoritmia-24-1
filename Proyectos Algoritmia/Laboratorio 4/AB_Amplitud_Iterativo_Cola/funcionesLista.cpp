...
void insertarAlInicio(struct Lista & lista, struct NodoArbol * elemento) {
...
void insertarEnOrden(struct Lista & lista, struct NodoArbol * elemento) {
...
struct Nodo * obtenerNodoAnterior(const struct Lista & lista, struct NodoArbol * elemento) {
...
struct Nodo * seEncuentra(const struct Lista & lista, struct NodoArbol * elemento) {
    struct Nodo * recorrido = lista.cabeza;
...
void eliminaNodo(struct Lista & lista, struct NodoArbol * elemento) {
    struct Nodo * ultimo = nullptr;
    struct Nodo * recorrido = lista.cabeza;
