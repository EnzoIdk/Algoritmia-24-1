    ...
    if(esNodoVacio(raiz))
        ...
        if (raiz->elemento.lote > elemento.lote)
            ...
            if(raiz->elemento.lote < elemento.lote)
                ...
                cout<<endl<<"El elemento "<< elemento.lote <<" ya se encuentra en el árbol"<< endl;
}
...
struct NodoArbol * eliminarNodoRecursivo(struct NodoArbol * nodo, 
        int elemento){
        ...
        if(nodo->elemento.lote < elemento)
            ...
            if(esNodoVacio(nodo->izquierda)){
                ...
                if(esNodoVacio(nodo->derecha)){
                    ...
                    nodo->elemento.lote = minNodo->elemento.lote;
                    nodo->elemento.cantidad = minNodo->elemento.cantidad;
                    /*se elimina el nodo que se reemplazo*/
                    nodo->derecha = eliminarNodoRecursivo(nodo->derecha, minNodo->elemento.lote);
                }   
    return nodo;
